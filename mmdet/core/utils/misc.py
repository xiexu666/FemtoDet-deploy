...
class IBEConvModule(BaseModule):
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1,
                 padding=1, dilation=1, groups=1, bias=False, deploy = False, act_cfg=None, **kwargs):
    ...
    def switch_to_deploy(self):
        ...
        self.rbr_reparam.bias.data = bias_final        
    ...
    def forward(self, x):
        ...
        if self.deploy:
            ...
            outs = self.act(self.bn(out_normal) + self.bn2(out_normal - theta * out_diff))
        return outs
