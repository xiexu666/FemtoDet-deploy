#dataset
work_dir = 'work_dirs_pcb/femtodet_stage0_pcb_cocopretrain_640_cocopretrain'
...
num_last_epochs=0
max_epochs=300
test_img_scale=(640,640)
pretrain_weight='/home/xiexu/code/v2/mmdet3/femto2/checkpoint/femtodet_nano_backbone_pretrained_model_witc_cd_conv2_4973.pth'
# load_from = None
load_from = 'work_dirs_pcb/femtodet_stage0_pcb_xiexu_coco/best_bbox_mAP_epoch_287.pth'
resume_from = None
#more information
optimizer = dict(
    type='SGD',
...
custom_hooks = [
    dict(type='FemtoDetModeSwitchHook', num_last_epochs=num_last_epochs, priority=48, all_unfreeze_after_this_epoch=50),
...
interval = 10
evaluation = dict(
    save_best='auto', interval=10, dynamic_intervals=[(30, 1)], metric='bbox')